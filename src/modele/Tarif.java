...
import java.util.HashMap;
	...
	public class Tarif {
		static HashMap<Double,Integer> prixCourPleinTarif ;
		static HashMap<Double,Integer> prixCourTarifReduit;
		static HashMap<Double,Paiement3fois> prixCourPleinTarif3fois;
		static HashMap<Double,Paiement3fois> prixCourTarifReduit3fois;

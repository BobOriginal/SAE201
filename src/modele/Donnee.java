...
public class Donnee {
	...
	static public void chargementDonnees() { 
		try {
			...
			Personne p2 = new Personne("nomP2","prenomP2",Personne.ELEVE_TARIF_REDUIT,"Morlaix",CotisationAnnuelle.PAIMENT_MULTIPLE,"Mme");
			Personne p3 = new Personne("nomP3","prenomP3",Personne.ELEVE_PLEIN_TARIF,"Rennes",CotisationAnnuelle.PAIMENT_UNIQUE,"Mme");
			Personne p4 = new Personne("nomP4","prenomP4",Personne.ELEVE_PLEIN_TARIF,"Lannion",CotisationAnnuelle.PAIMENT_MULTIPLE,"Mr");
			Personne p5 = new Personne("nomP5","prenomP5",Personne.NON_INSCRIT,"Lannion",CotisationAnnuelle.PAIMENT_MULTIPLE,"Mme");
			...
			Personne p8 = new Personne("nomP8","prenomP8",Personne.ELEVE_TARIF_REDUIT,"Angers",CotisationAnnuelle.PAIMENT_MULTIPLE,"Mr");
			Personne p9 = new Personne("nomP9","prenomP9",Personne.ELEVE_TARIF_REDUIT,"Angers",CotisationAnnuelle.PAIMENT_UNIQUE,"Mr");
			Personne p10 = new Personne("nomP10","prenomP10",Personne.ELEVE_PLEIN_TARIF,"Lannion",CotisationAnnuelle.PAIMENT_MULTIPLE,"Mme");
			Personne p11 = new Personne("nomP11","prenomP11",Personne.ELEVE_TARIF_REDUIT,"Rennes",CotisationAnnuelle.PAIMENT_MULTIPLE,"Mme");
			Personne p12 = new Personne("nomP12","prenomP12",Personne.NON_INSCRIT,"Morlaix",CotisationAnnuelle.PAIMENT_MULTIPLE,"Mr");
			Personne p13 = new Personne("nomP13","prenomP13",Personne.ELEVE_PLEIN_TARIF,"Lannion",CotisationAnnuelle.PAIMENT_UNIQUE,"Mme");
			
			CoursDebutant c1 = new CoursDebutant(2025, 1, "c1");
			CoursIntermediare c2 = new CoursIntermediare(2025, 2, "c2");
			CoursAvancer c3 = new CoursAvancer(2025, 3, "c3");
			CoursDebutant c4 = new CoursDebutant(2025, 2, "c4");
			CoursIntermediare c5 = new CoursIntermediare(2025, 5, "c5");
